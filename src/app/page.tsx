  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-100">
      ...
      <div className='flex gap-4 justify-center items-center bg-blue-10  pt-4 '>
        ...
        />
        <h1 className="text-3xl md:text-4xl font-bold drop-shadow-lg   max-md:text-2xl max-sm:text-xl">Don Bosco Institute of Technology</h1>
      </div>
      <header className="py-6 flex flex-col items-center justify-center">
        {/* College Logo and Name */}
        <div className="flex flex-col items-center mb-6">

          <h3 className="text-lg md:text-3xl font-medium">Leave Management System</h3>
        </div>
        ...
        <div className="text-center">
          ...
          <section className="flex gap-4 mt-8 justify-center">
            <a
              href="/login"
              className="bg-blue-600 text-white  w-[150px] h-[50px]  flex justify-center items-center rounded-full text-lg font-semibold shadow-lg hover:bg-blue-700 transition-colors duration-300"
            >
              Login
            </a>
            <a
      ...
      <main className="container mx-auto px-6 py-12">
        <section className="text-center mb-12">
          <h2 className="text-4xl font-bold mb-6 max-sm:text-3xl">System Features</h2>
